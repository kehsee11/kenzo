...
const Home = () => {
     return (
          <div name="home" className="md:h-[90vh] w-full bg-gradient-to-b from-black via-black to-gray-800 pt-[5vh] lg:pt-[20vh]">
               <div className="lg:w-[80%] mx-auto flex flex-col-reverse items-center justify-center h-full px-4 md:flex-row">
                    <div className="flex flex-col justify-center h-full md:w-3/5">
                         ...
                         <p className="text-gray-500 text-xs md:text-[24px] py-4 max-w-md">Passionate, Front-End Developer. With vast experience in building (frontend web and app) applications.
