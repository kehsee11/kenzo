     ...
     return (
          <div name="about" className="w-full bg-gradient-to-b from-gray-800 to-black text-white pt-[10vh] lg:pt-0">
               <div className="p-4 mx-auto flex flex-col justify-center w-[90%] h-full pt-20">
                    ...
                    <div className="mt-8">
                         <p className="lg:text-2xl text-gray-500"><span className="font-bold">A Front-End Maestro Orchestrating User Experiences with React and Flutter </span>
                         ...
                         <p className="lg:text-2xl text-gray-500 mt-4">While I have established myself as a proficient React developer, I am currently expanding my horizons into Flutter development, aiming to translate my frontend expertise into the realm of mobile applications.
                         ...
                         <p className="lg:text-2xl text-gray-500 mt-4">With a passion for learning and an eye for detail, I am committed to bridging the gap between React's excellence in web development and emerging as a competent Flutter developer.
